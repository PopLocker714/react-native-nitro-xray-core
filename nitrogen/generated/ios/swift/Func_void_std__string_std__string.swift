...
/**
 * Wraps a Swift `(_ state: String, _ message: String) -> Void` as a class.
...
public final class Func_void_std__string_std__string {
  ...
  private let closure: (_ state: String, _ message: String) -> Void

  public init(_ closure: @escaping (_ state: String, _ message: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(state: std.string, message: std.string) -> Void {
    self.closure(String(state), String(message))
  }
