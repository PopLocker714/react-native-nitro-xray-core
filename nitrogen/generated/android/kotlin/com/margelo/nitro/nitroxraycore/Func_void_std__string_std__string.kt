...
/**
 * Represents the JavaScript callback `(state: string, message: string) => void`.
...
fun interface Func_void_std__string_std__string: (String, String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(state: String, message: String): Unit
}
...
class Func_void_std__string_std__string_cxx: Func_void_std__string_std__string {
  ...
  @Keep
  override fun invoke(state: String, message: String): Unit
    = invoke_cxx(state,message)

  @FastNative
  private external fun invoke_cxx(state: String, message: String): Unit
}
...
class Func_void_std__string_std__string_java(private val function: (String, String) -> Unit): Func_void_std__string_std__string {
  ...
  @Keep
  override fun invoke(state: String, message: String): Unit {
    return this.function(state, message)
  }
}
